...
const AddPlace = ({ navigation }) => {
    ...
    function savePlaceHandler() {
        // Para recuperar lugares existentes de AsyncStorage
        AsyncStorage.getItem('places')
            .then(storedPlaces => {
                ...
                // Para Verificar si existingPlaces es un array
                ...
                // Para almacenar la lista actualizada en AsyncStorage
                AsyncStorage.setItem('places', JSON.stringify(updatedPlaces))
                    .then(() => {
                        console.log('Lugar guardado en AsyncStorage');
                        navigation.navigate('AllPlaces', {
                            places: updatedPlaces // Para pasar la lista completa de lugares a la pantalla AllPlaces
                        });
                    })
                    .catch(error => {
